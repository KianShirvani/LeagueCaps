...
VALUES 
('Dallas Cowboys Cap', 1, 'Official adjustable cap for Dallas Cowboys fans.', 29.99),
('New England Patriots Cap', 1, 'Official adjustable cap for New England Patriots fans.', 29.99),
('Green Bay Packers Cap', 1, 'Official adjustable cap for Green Bay Packers fans.', 29.99),
('San Francisco 49ers Cap', 1, 'Official adjustable cap for San Francisco 49ers fans.', 29.99),
('Seattle Seahawks Cap', 1, 'Official adjustable cap for Seattle Seahawks fans.', 29.99),
('Chicago Bears Cap', 1, 'Official adjustable cap for Chicago Bears fans.', 29.99),
('Kansas City Chiefs Cap', 1, 'Official adjustable cap for Kansas City Chiefs fans.', 29.99),
('Baltimore Ravens Cap', 1, 'Official adjustable cap for Baltimore Ravens fans.', 29.99);

-- MLB Caps
INSERT INTO product (productName, categoryId, productDesc, productPrice)
VALUES 
('New York Yankees Cap', 2, 'Official adjustable cap for New York Yankees fans.', 24.99),
('Los Angeles Dodgers Cap', 2, 'Official adjustable cap for Los Angeles Dodgers fans.', 24.99),
('Chicago Cubs Cap', 2, 'Official adjustable cap for Chicago Cubs fans.', 24.99),
('San Francisco Giants Cap', 2, 'Official adjustable cap for San Francisco Giants fans.', 24.99),
('Boston Red Sox Cap', 2, 'Official adjustable cap for Boston Red Sox fans.', 24.99),
('Houston Astros Cap', 2, 'Official adjustable cap for Houston Astros fans.', 24.99),
('St. Louis Cardinals Cap', 2, 'Official adjustable cap for St. Louis Cardinals fans.', 24.99),
('Philadelphia Phillies Cap', 2, 'Official adjustable cap for Philadelphia Phillies fans.', 24.99);

-- NBA Caps
INSERT INTO product (productName, categoryId, productDesc, productPrice)
VALUES 
('Los Angeles Lakers Cap', 3, 'Official adjustable cap for Los Angeles Lakers fans.', 27.99),
('Chicago Bulls Cap', 3, 'Official adjustable cap for Chicago Bulls fans.', 27.99),
('Golden State Warriors Cap', 3, 'Official adjustable cap for Golden State Warriors fans.', 27.99),
('Miami Heat Cap', 3, 'Official adjustable cap for Miami Heat fans.', 27.99),
('Brooklyn Nets Cap', 3, 'Official adjustable cap for Brooklyn Nets fans.', 27.99),
('Boston Celtics Cap', 3, 'Official adjustable cap for Boston Celtics fans.', 27.99),
('Dallas Mavericks Cap', 3, 'Official adjustable cap for Dallas Mavericks fans.', 27.99),
('Philadelphia 76ers Cap', 3, 'Official adjustable cap for Philadelphia 76ers fans.', 27.99);
